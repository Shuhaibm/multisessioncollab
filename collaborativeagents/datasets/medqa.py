...
class MedQA():
    def __init__(self, dataset_name="GBaker/MedQA-USMLE-4-options", eval_size=20, seed=42, cache_dir=os.path.join(os.path.dirname(__file__), "cache"), training=False):
        self.dataset_name = dataset_name
        self.eval_size = eval_size
        self.seed = seed
        self.cache_dir = os.path.join(cache_dir, "medqa")
