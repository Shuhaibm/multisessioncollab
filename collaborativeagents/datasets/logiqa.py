...
class LogiQA():
    def __init__(self, dataset_name="hails/agieval-logiqa-en", eval_size=20, seed=42, cache_dir=os.path.join(os.path.dirname(__file__), "cache"), training=False):
        self.dataset_name = dataset_name
        self.eval_size = eval_size
        self.seed = seed
        self.cache_dir = os.path.join(cache_dir, "logiqa")
    ...
    def get_trainset(self):
        ...
        for item in ds_shuffled:
            ...
            if problem not in test_problems:
                solution = item['choices'][item['gold'][0]]
